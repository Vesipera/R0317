...
import javafx.scene.control.Alert;				// Virheilmoituksia varten
...
public class JuomaAutomaatti {
	...
	public void valmistaKahvi() {		// Tulostetaan ilmoitukset juomien loppumisesta ruudulle.
		if (this.kahvi - 10 < 0) {
			...
			alert.setTitle("Loppu!");
			alert.setHeaderText(null);
			alert.setContentText("Kahvi loppu! Lisää saa yläpalkista.");
			alert.showAndWait();
		} else {
			this.kahvi -= 10;
		}
	...
	public void valmistaTee() {
		if (this.tee - 10 < 0) {
			...
			alert.setTitle("Loppu!");
			alert.setHeaderText(null);
			alert.setContentText("Tee loppu! Lisää saa yläpalkista.");
			alert.showAndWait();
		} else {
			this.tee -= 10;
		}
	...
	public void valmistaKaakao() {
		if (this.kaakao - 10 < 0) {
			...
			alert.setTitle("Loppu!");
			alert.setHeaderText(null);
			alert.setContentText("Kaakao loppu! Lisää saa yläpalkista.");
			alert.showAndWait();
		} else {
			this.kaakao -= 10;
		}
